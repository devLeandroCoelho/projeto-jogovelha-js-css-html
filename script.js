document.addEventListener("DOMContentLoaded", function () {
  ...
  function handleCellClick(index) {
    if (
      !gameActive ||
      gameBoard[index] !== "" ||
      (currentPlayer === "O" && isComputerPlayer())
    ) {
      return;
    }
  ...
  // Associar a função restartGameSemDisplayNone ao evento de clique no botão
  restartGames.addEventListener("click", restartGame);
